...
return (
    <section className="absolute z-0 grid lg:grid-cols-3 grid-cols-1 gap-3 p-4 w-full">
        {chajas === "" ? <p className="font-bold">CARGANDO CHAJAS...</p> : chajas.map ( chaja => {
            return <article key={chaja.id} className="overflow-hidden	 shadow-lg font-semibold m-2 bg-white rounded border-4 b-gray-900 py-2 px-4 text-xl text-gray-700 transition  hover:bg-purple-800 hover:text-white">
